...
class GeneticAlgorithm:
    def __init__(self, instance_data, pop_size=50, num_generations=100, crossover_rate=0.95, mutation_rate=0.05, elitism_rate=0.25, local_search_swaps = 5):
    ...
    def run(self, instance_data, scheduler, heuristic_func=None):
        ...
        for gen in range(self.num_generations):
            ...
            while len(new_population) < self.pop_size:
                ...
                child1 = self.local_search(child1, scheduler,
                                           instance_data,
                                           swaps=self.local_search_swaps)
                child2 = self.local_search(child2, scheduler,
                                           instance_data,
                                           swaps=self.local_search_swaps)
